                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                <textarea class="form-control @error('name') is-invalid @enderror" id="exampleFormControlTextarea1" name="alamat" rows="3" required autocomplete="name" autofocus>{{ $user->alamat }}</textarea>
                              </div>
