...
<div class="container">
   ...
   <div class="card">
     <div class="card-body">
        ...
        <h5>Pesanan anda sudah sukses di check out selennjutnya untuk pemebayaran selahkan transfer ke rekening <strong> Bank BRI Nomer Rekening : 32113-821312-123</strong> dengan nominal : <strong>Rp. {{ number_format($pesanan->kode+$pesanan->jumlah_harga)}}</strong> </h5>
     </div>
   </div>
     <div class="card mt-2">
       <div class="card-body">
            ...
            <tbody>
               ...
               @foreach( $pesanan_details as $pesanan_detail )
                 <tr>
                   ...
                   <td align="right">
                      Rp. {{ number_format($pesanan_detail->barang->harga )}}
                   </td>
                   <td align="right">
